...
const Form = () => {
    ...
    const submitHandler = async (event) => {
        ...
        try {
            ...
            toast.error("Failed to submit the form email may already exist");
        }
    };


    return (
        <div className="flex flex-col p-2 bg-gradient-to-br from-gray-100 to-gray-200 min-h-screen items-center justify-center mt-14">
